    ...
    >
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-2xl font-bold">EduJavon</span>
            </div>
            <p className="text-gray-400 mb-4 leading-relaxed">
              Zamonaviy kutubxona boshqaruv tizimi. Kitoblaringizni oson va
              qulay boshqaring.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-4">Tez Havolalar</h3>
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>&copy; 2026 EduJavon. Barcha huquqlar himoyalangan.</p>
        </div>
      </div>
    </footer>
  );
