...
import { SearchNormal as Search, UserAdd as UserPlus, DocumentText as FileSpreadsheet } from 'iconsax-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="border-success/30 text-success rounded-xl h-10 px-4 font-label text-xs uppercase hover:bg-success/10">
            <FileSpreadsheet color="currentColor" size={16} variant="Bulk" className="mr-2" /> Excel Export
          </Button>
          <Button 
          ...
          >
            <UserPlus color="currentColor" size={16} variant="Bulk" className="mr-2" /> A'zo qo'shish
          </Button>
        </div>
      </div>
