...
import { Book as BookOpen, ArrowLeft2 as ArrowLeft, Star1 as Star, Clock as Clock, Copy as Copy, Edit2 as Edit3 } from 'iconsax-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
           ...
           <div className="w-40 h-56 bg-surface-1 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center relative mb-6">
             <BookOpen color="currentColor" size={48} className="text-accent/50 mb-4" />
           ...
           <div className="w-full flex justify-between px-4 mt-2">
             ...
             <div className="text-center">
               ...
               <p className="font-number text-2xl text-accent flex items-center gap-1 justify-center"><Star color="currentColor" size={14} fill="currentColor" /> 4.8</p>
             </div>
           </div>
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col gap-6">
           ...
           >
             <div className="flex justify-between items-center mb-6">
               ...
               <Button variant="outline" className="border-accent/30 text-accent h-8 px-3 text-[10px]"><Edit3 color="currentColor" size={14} className="mr-2"/> Tahrirlash</Button>
             </div>
                ...
                {Array.from({length: book.copies > 3 ? 3 : Math.max(1, book.copies)}).map((_, i) => (
                  <div key={i} className="flex justify-between items-center p-3 bg-white/5 border border-white/5 rounded-xl">
                    <div className="flex items-center gap-3">
                      <Copy color="currentColor" size={16} className="text-slate" />
                      <div>
             ...
             <div className="divide-y divide-white/5">
                <div className="py-3 flex justify-between items-center">
                  <div className="flex flex-col">
                    ...
                    <span className="text-slate text-[10px] flex items-center gap-1"><Clock color="currentColor" size={10}/> 12 Okt 2025 qaytargan</span>
                  </div>
                ...
                <div className="py-3 flex justify-between items-center">
                  <div className="flex flex-col">
                    ...
                    <span className="text-slate text-[10px] flex items-center gap-1"><Clock color="currentColor" size={10}/> 05 Sen 2025 qaytargan</span>
                  </div>
